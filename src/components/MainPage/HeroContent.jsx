    ...
    return (
        ...
        <article style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
            <div style={{ width: '40%', display: 'flex', flexDirection: 'column', gap: 20, }}>
                <h1>Envision Craft Ignite with <br /><span style={{ color: 'var(--color-accent)' }}>hikiverse</span></h1>
                <p style={{lineHeight: '1.7',fontSize: '1.2rem', textAlign: 'start', color: 'var(--color-text)'  }}>
